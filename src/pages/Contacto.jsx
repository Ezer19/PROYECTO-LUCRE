    ...
    <div className="pt-32 pb-20">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h1 className="text-3xl md:text-4xl font-bold mb-4 text-primary">Contáctanos</h1>
          <div className="w-24 h-1 bg-accent mx-auto mb-6"></div>
          <p className="text-xl text-gray-700 max-w-3xl mx-auto">
            ¿Tienes preguntas, sugerencias o quieres colaborar con nuestro proyecto? Escríbenos.
          </p>
        </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">proyectos@lucesdelande.org</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-bold text-lg text-accent">Oficina Principal</h4>
                    <p className="text-gray-700">Av. Cultura 123</p>
